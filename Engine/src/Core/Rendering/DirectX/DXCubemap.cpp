...
//
//bool DXCubemap::init(unsigned width, unsigned height)
//{
//	if (!initialized) {
...
//			ANK_ASSERT(SUCCEEDED(dev->CreateRenderTargetView(this->cubemap.Get(), &rtvDesc, this->renderTargets[i].ReleaseAndGetAddressOf())),
